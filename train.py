...
def get_data(input_path, dataPath):
...
train_path =  'trainAnnotationsFinal.txt' # Training data (annotation file)
...
#--------------------------------------------------------#
st = time.time()
train_imgs, classes_count, class_mapping = get_data(train_path, train_data_path)
print()
